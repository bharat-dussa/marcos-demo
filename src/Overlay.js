...
const Overlay = forwardRef(({ caption, scroll }, ref) => (
  <div
    ...
    <div style={{ height: "170vh" }}>
      <div class="dot glass-morphism-wrapper">
        <h1>
          Welcome to <br /> Web development
        </h1>
      </div>
      <div class="glitch-wrapper">
        <div class="glitch" data-glitch="Marcos Tech Institute">
          Marcos Tech Institute
        </div>
      </div>
    </div>
    ...
    <div style={{ height: "200vh" }}>
      <div class="dot">
        <h1>Move </h1>A Zeppelin is a type of rigid airship named after the German inventor Count Ferdinand von Zeppelin (German pronunciation: [ˈt͡sɛpəliːn]) who pioneered rigid
        airship development at the beginning of the 20th century.
      </div>
    </div>
    <div class="thank-you-wrapper" style={{ height: "100vh" }}>
      <div class="thank-you"><h3>Let's add wings to your path</h3> Lets start with Marcos</div>
    </div>
